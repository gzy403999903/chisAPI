 ...
 * @Version 1.0
 */
@RequestMapping("/westernDiagnoseClassify")
@RestController
public class WesternDiagnoseClassifyHandler extends DiagnoseClassifyHandler {

    public WesternDiagnoseClassifyHandler() {
